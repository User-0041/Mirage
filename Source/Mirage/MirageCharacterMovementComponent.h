...
public:
	...
	//Wall Run
	UPROPERTY(EditDefaultsOnly)
	float WallRun_MinSpeed = 200.f;
	UPROPERTY(EditDefaultsOnly)
	float WallRun_MaxSpeed = 800.f;
	UPROPERTY(EditDefaultsOnly)
	float WallRun_MaxVerticalSpeed = 200.f;
	UPROPERTY(EditDefaultsOnly)
	float WallRun_PullAwayAngel = 75.f;
	UPROPERTY(EditDefaultsOnly)
	float WallRun_AttractionForce = 200.f;
	UPROPERTY(EditDefaultsOnly)
	float WallRun_MinHeight = 50.f;
	UPROPERTY(EditDefaultsOnly)
	float WallRun_JumpForce = 400.f;
	UPROPERTY(EditDefaultsOnly)
...
public:
	...
	UPROPERTY(Transient)
	AMirageCharacter* MirageCharacterOwner;
	UPROPERTY(Transient)
...
private:
	...
	UFUNCTION(Server, Reliable)
	void Server_EnterTryClimb();

private:
	bool TryCover();
	void PhysCover(float deltaTime, int32 Iterations);
	UFUNCTION(Server, Reliable)
	void Server_EnterTryCover();
